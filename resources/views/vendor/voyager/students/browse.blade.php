...
@section('page_header')
    <div class="container-fluid">
        ...
        <!-- Add "Import Student" button -->
        <a href="{{ route('backend.excel.getImportStudents') }}" class="btn btn-primary btn-add-new">
            <i class="voyager-harddrive"></i> <span>Import Students</span>
        </a>
        <!-- End \ Add "Import Student" button -->
